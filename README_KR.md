...
✅ **최소 2048비트 키 사용**
- 1024비트는 더 이상 안전하지 않음
- 2048비트: 일반 기업용 (권장)
- 4096비트: 고보안 환경

✅ **OAEP 패딩 사용**
- `OAEP_SHA256`이 가장 안전
- `PKCS1v15`는 호환성이 필요한 경우만
- `NoPadding`은 절대 사용 금지
...
| 키 크기 | 보안 수준 | 속도 | 용도 |
|---------|-----------|------|------|
| 1024비트 | ⚠️ 낮음 | 빠름 | 레거시 시스템만 |
| 2048비트 | ✅ 높음 | 보통 | 일반 기업용 (권장) |
| 4096비트 | ✅ 매우 높음 | 느림 | 고보안 환경 |

## 성능

2048비트 키 기준 (Intel i7):
...
⚠️ **암호화 규제**
- 일부 국가에서는 암호화 사용이 제한될 수 있습니다
- 해당 국가의 법률을 확인하세요

---

**Nim으로 만든 기업용 암호화 라이브러리** 🔐
